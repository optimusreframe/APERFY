  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "bg-float-1": "bg-float-1 10s ease-in-out infinite",
        "bg-float-2": "bg-float-2 14s ease-in-out infinite",
        "bg-float-3": "bg-float-3 9s ease-in-out infinite",
        "bg-drift": "bg-drift 12s ease-in-out infinite",
      },
    },
  },
