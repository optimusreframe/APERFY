...
const Email = ({ customerName, productName }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>We received your custom model request!</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>{customerName ? `Hi ${customerName},` : 'Hi,'} thank you for submitting your custom model request{productName ? ` for "${productName}"` : ''}!</Text>
          ...
          <Text style={text}>We're excited to bring your idea to life with premium 3D printing!</Text>
