    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>{customerName ? `Hi ${customerName},` : 'Hi,'} your order <strong style={{ color: '#fff' }}>#{orderId?.slice(0, 8).toUpperCase()}</strong> has been delivered!</Text>
          <Text style={text}>We hope you love your 3D printed items! If you have a moment, we'd appreciate a review — it helps other customers and our team.</Text>
          <Text style={text}>If anything isn't right, don't hesitate to reach out. We're here to help.</Text>
...
export const template = {
  component: Email,
  subject: (data: Record<string, unknown>) => `Order #${String(data.orderId || '').slice(0, 8).toUpperCase()} — Delivered!`,
