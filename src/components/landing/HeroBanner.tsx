...
const banners = [
  { icon: Search, en: ['Curated finds, ready to discover', 'Useful products with clear details and a signal worth following.', 'Explore finds', '/catalog'], es: ['Hallazgos seleccionados para descubrir', 'Productos útiles con detalles claros y una señal que vale la pena seguir.', 'Explorar hallazgos', '/catalog'] },
  ...
  { icon: ShieldCheck, en: ['Details that matter', 'Condition, source and availability — choose with confidence.', 'Read the signals', '/materials'], es: ['Detalles que importan', 'Condición, fuente y disponibilidad para elegir con confianza.', 'Leer las señales', '/materials'] },
  { icon: Users, en: ['Join the APERFY signal', 'Save finds, follow new drops and keep your next decision close.', 'Create account', '/auth'], es: ['Únete a la señal APERFY', 'Guarda hallazgos, sigue novedades y mantén cerca tu próxima decisión.', 'Crear cuenta', '/auth'] },
];
